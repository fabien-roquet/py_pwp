...
'ocean_relax_switch'  : 1 ,# relaxation switch
'sss_relax_switch'  : 1 ,# sea surface salinity relaxation switch
'ekman_switch'    : 0 ,    # ekman advection
...
'epsilon'     : 1,  # effective fraction of u_star in Kraus-Turner
    
# time scale of relaxation
'OR_days'     : 180.,
'ad_depth'    : 200. , #if relaxation below a specific depth
'sss_days'    :  90.,
