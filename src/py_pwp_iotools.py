...
def load_forcing_fields(forcing_file, time):
    ...
    # Example of an npz file as made from provided scripts.
        ...
        def tau_from_u10(u10,u_a,rho_air_ref=1.275,cd_air=0.0015):
            ...
            return rho_air_ref*u_a*u10*cd_air
        tx_series = tau_from_u10(u10_series,U_a_series)
        ty_series = tau_from_u10(v10_series,U_a_series)
